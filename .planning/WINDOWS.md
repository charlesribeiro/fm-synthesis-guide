...
fixed_count: 1
total_count: 2
last_updated: 2026-09-21T17:20:00.000Z
---
...
| 2 | 12 | deviation | src/app/state/lesson-progress.ts |  | markComplete uses Injector.get instead of method-level inject() (NG0203) | waived | Required workaround for method-level inject() NG0203: calling inject() from markComplete can fail outside an Angular injection context; Injector.get(SavedDocumentStore) is the accepted lazy lookup. Implementation unchanged. | 2026-09-09T13:35:25.916Z | 2026-09-21T17:20:00.000Z |
...
[
  ...
  },
  {
    ...
    "kind": "deviation",
    "phase": "12",
    "file": "src/app/state/lesson-progress.ts",
    "line": null,
    "description": "markComplete uses Injector.get instead of method-level inject() (NG0203)",
    "status": "waived",
    "reason": "Required workaround for method-level inject() NG0203: calling inject() from markComplete can fail outside an Angular injection context; Injector.get(SavedDocumentStore) is the accepted lazy lookup. Implementation unchanged.",
    "recorded_at": "2026-09-09T13:35:25.916Z",
    "resolved_at": "2026-09-21T17:20:00.000Z"
  }
]
````
