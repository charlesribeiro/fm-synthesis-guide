...
tech-stack:
  added: []
  patterns:
    - "Index-parameterised hostile-payload generation: a loop over rates/levels x 4 indices x {wrong-type, non-integer, non-finite, below-min, above-max} builds the 40 malformed envelope entry-value cases, rather than 40 hand-written literal cases; positive boundary cases are stated separately"
