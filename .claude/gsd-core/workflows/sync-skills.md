...
INSTALL_JS_GLOBAL="/Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
