...
<required_reading>
@/Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/gsd-core/references/ai-frameworks.md
@/Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/agents/gsd-eval-planner.md for instructions.
