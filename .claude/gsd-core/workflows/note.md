...
- **Global scope**: `/Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/notes/`)
...
2. Glob `/Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/notes/` — works in any directory
