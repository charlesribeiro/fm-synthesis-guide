...
```
Agent(
  prompt="Read /Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/gsd-core/templates/VALIDATION.md`
