...
- Usage: Reference from command with `@/Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
