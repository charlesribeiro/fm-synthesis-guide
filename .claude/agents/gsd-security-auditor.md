...
**Verification depth scales with `asvs_level`** (see @/Users/charles/Documents/GitHub/fm-synthesis-guide/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
